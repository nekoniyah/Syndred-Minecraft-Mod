package net.syndred.syndred;

import org.apache.logging.log4j.Logger;
import org.apache.logging.log4j.LogManager;

import net.syndred.syndred.world.features.StructureFeature;
import net.syndred.syndred.init.*;
...
@Mod("syndred")
public class SyndredMod {
	public static final Logger LOGGER = LogManager.getLogger(SyndredMod.class);
	public static final String MODID = "syndred";

	public SyndredMod(IEventBus modEventBus) {

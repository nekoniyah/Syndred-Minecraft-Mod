...
public class SyndredModTabs {
	...
	public static final DeferredHolder<CreativeModeTab, CreativeModeTab> SYNDRED_TAB = REGISTRY.register("syndred_tab",
			() -> CreativeModeTab.builder().title(Component.translatable("item_group.syndred.syndred_tab")).icon(() -> new ItemStack(SyndredModBlocks.ANIMA_CONFLUX.get())).displayItems((parameters, tabData) -> {
				...
				tabData.accept(SyndredModItems.SPHALERITE_SWORD.get());
				tabData.accept(SyndredModItems.SPHALERITE_PICKAXE.get());
				tabData.accept(SyndredModItems.SPHALERITE_AXE.get());
				tabData.accept(SyndredModItems.SPHALERITE_HOE.get());
				tabData.accept(SyndredModItems.SPHALERITE_SHOVEL.get());
				tabData.accept(SyndredModItems.SCARLET_CORE.get());
			}).build());
